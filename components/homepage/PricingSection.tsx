    ...
    <section id="concours" className="border-t bg-muted/30 py-16 md:py-24">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center gap-4 text-center md:gap-8">
          ...
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Règles, séléction et récompenses</h2>
        ...
        <div className="mx-auto mt-16 grid max-w-5xl gap-6 lg:grid-cols-2" id="inscription-concours">
          <div className="rounded-2xl border bg-background p-6">
            ...
            <p className="mt-3 text-muted-foreground">
              Les projets non selectionnés ne sont pas de mauvais projets. La selection est limitée a cinq projets pour la presentation officielle.
            </p>

            <h4 className="mt-6 text-lg font-semibold">Déroulement du concours</h4>
          ...
          <div className="rounded-2xl border bg-background p-6">
            ...
            <h4 className="mt-6 text-lg font-semibold">Critères d'évaluation</h4>
            <ul className="mt-3 space-y-2 text-muted-foreground">
